        ...
        return _createClass(SlideConfigParser, [
            ...
            },
            {
                ...
                value: function setSize(data, settings) {
                    ...
                    var defaultWith =
                        data.type == "video" ? this.checkSize(settings.videosWidth) : this.checkSize(settings.width);
                ...
                value: function resize() {
                    ...
                    if (image) {
                        if (winWidth <= 768) {
                            ...
                            var maxHeightValue =
                                (_slideTriggerNode$get = slideTriggerNode.getAttribute("data-height")) !== null &&
                                _slideTriggerNode$get !== void 0
                                    ? _slideTriggerNode$get
                                    : "100vh";
                            _imgNode.setAttribute(
                                "style",
                                "max-height: calc(".concat(maxHeightValue, " - ").concat(descHeight, "px)")
                            );
